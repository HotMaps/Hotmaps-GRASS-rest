...
api_v1 = Api( # pylint: disable=invalid-name
    version='1.0',
    title="GRASS GIS REST API",
    description=(
        "It is a RESTful API server for [GRASS GIS](https://grass.osgeo.org/)."
        "The code started from [real-life example RESTful API server implementation using Flask-RESTplus project]"
