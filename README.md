...
This project aims to develop a REST API for GRASS GIS. The project inherit the code from [Flask RESTplus Server Example](https://github.com/frol/flask-restplus-server-example).
